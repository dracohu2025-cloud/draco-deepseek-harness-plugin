...
* Imagine Image 2.0 and an unset video backend to Imagine Video. An explicit
...
function apply(ctx, config) {
	...
	ctx.tools.register(defineTool({
		name: "video_generate",
		description: "Generate a short video from a text prompt. SuperGrok login defaults to grok-imagine-video. Settings → Draco-suite chooses the backend. The MP4 is written under $DSH_HOME/draco/videos/.",
		parameters: {
			prompt: {
				type: "string",
				required: true,
