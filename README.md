...
| Music / MiniMax Music 3 | `dsh plugin --profile web add github:dracohu2025-cloud/draco-deepseek-harness-plugin#path:music` | `music_generate` via MiniMax `music-3.0` / `music-3.0-free`; the chat tool row plays the MP3 (copy under `$DSH_HOME/draco/music/`) |
